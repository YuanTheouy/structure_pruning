...
def export_model(env, args):
    ...
    if args.ratios:
        ...
        if args.structure:
            ...
            ratios = torch.ones(env.num_hidden_layers * 6).cpu()
...
if __name__ == "__main__":
    ...
    if args.job == 'train':
        ...
        agent = SAC(nb_actions, nb_states, args.hidden1, args.hidden2, args.rmsize, args.lr_a, 1, args.bsize, args.gamma,
                    args.tau, alpha, args.init_delta, args.delta_decay, args.warmup)
