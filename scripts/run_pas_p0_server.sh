...
DELTA=${DELTA:-"0.05"}
TRAIN_EPISODES=${TRAIN_EPISODES:-"400"}
N_SAMPLES=${N_SAMPLES:-"16"}
TOP_K=${TOP_K:-"20"}
SHORTLIST_SIZE=${SHORTLIST_SIZE:-"2"}
RANDOM_REPEATS=${RANDOM_REPEATS:-"500"}
NUM_COLLECT=${NUM_COLLECT:-"5"}
LEARNING_EPOCH=${LEARNING_EPOCH:-"3"}
SEED=${SEED:-"2025"}
HELDOUT_SPARSITY=${HELDOUT_SPARSITY:-"0.40"}
HELDOUT_N_SAMPLES=${HELDOUT_N_SAMPLES:-"32"}
