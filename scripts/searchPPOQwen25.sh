#!/bin/bash
# =================================================================================
#    AMC-LLM 剪枝搜索脚本 - Qwen1.5-7B PPO训练版本 (增强版)
# =================================================================================
#
#   用法:
#       1. 基础用法: ./scripts/searchPPOQwen15.sh
#       2. 指定GPU: ./scripts/searchPPOQwen15.sh --gpu-id "0,1"
#       3. 指定实验配置: ./scripts/searchPPOQwen15.sh --gpu-id "1,2" --exp-id 2
#       4. 指定目标稀疏度: ./scripts/searchPPOQwen15.sh --target-sparsity 0.2
#       5. 指定训练轮数: ./scripts/searchPPOQwen15.sh --train-episodes 8000
#       6. 兼容旧参数: ./scripts/searchPPOQwen15.sh --preserve-ratio 0.8  (会自动转换为稀疏度0.2)
#
# =================================================================================
...
if [ "$SHOW_HELP" = true ]; then
    ...
    echo "  $0 --use-dataset-growth --dataset-initial-ratio 0.1"
    echo "  $0 --use-gradual-pruning --use-dataset-growth"
    exit 0
fi
...
# --- 3. 固定参数配置 ---
MODEL_PATH="../../01_Models/Qwen2.5-7B"
# MODEL_PATH="/public/home/weijiateng2023/model/Qwen1.5-7B"
# MODEL_PATH="/home/lisiqi/amc-LLM/model/Qwen1.5-7B"
...
# 对于Python脚本，我们传递第一个GPU ID作为主GPU
...
EXPORT_PATH="./checkpoints/qwen15_7b_ppo_${SUFFIX}.pth.tar"
...
# --- 7. 显示实验配置信息 ---
echo "=================================================================="
echo "   启动 AMC-LLM 剪枝搜索 - ${MODEL_NAME} 实验 #${EXP_ID}"
echo "=================================================================="
echo "    实验配置:"
